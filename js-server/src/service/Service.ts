...
export default class Service {
    ...
    hashToSimpleSHA256(stringToHash:string):HashBenchmarks{
        ...
        return {benchmarks: {executionTime:timeInterval}, hashedString: hash, stringToHash,typeOfHash:"Simple SHA-256"};
    }
    ...
    hashToSimpleRIPEMD160(stringToHash:string):HashBenchmarks{
        ...
        const endTime = performance.now();
        const timeInterval = endTime - startTime;
        return {benchmarks: {executionTime:timeInterval}, hashedString: hash, stringToHash,typeOfHash:"Simple RIPEMD-160"};
    }
    ...
    hashToDoubleSHA256(stringToHash:string):HashBenchmarks{
        ...
        const endTime = performance.now();
        const timeInterval = endTime - startTime;
        return {benchmarks:{executionTime:timeInterval}, hashedString:hash, stringToHash,typeOfHash:"Double SHA-256"};
    }
    ...
    hashToSHAandRIPE(stringToHash:string):HashBenchmarks {
        ...
        const endTime = performance.now();
        const timeInterval = endTime - startTime;
        return {benchmarks:{executionTime:timeInterval}, hashedString:hash, stringToHash,typeOfHash:"SHA-256 and RIPEMD-160"};
    }
