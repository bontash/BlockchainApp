    ...
    return <>
        ...
        <MainSection>
            <BlockchainPageMainSection>
                <Typography fontSize={'115%'}>
                    ...
                    time
                    allowing a semi-transparency to exist. Its core mechanisms are the ones presented on the cards below. Hover over them to go
        ...
        <Grid container direction={'row'} justifyContent={'space-evenly'} alignItems={'center'}>
            <Grid item alignContent={'center'}>
                <BlockchainPageFlipCard pageName={'Mock'} description={"Protection against possible attacks, using a cryptographic " +
            ...
            <Grid item>
                <BlockchainPageFlipCard pageName={'Transactions'} description={"Exchange transactions without a third-party to facilitate the process. Everything is based " +
