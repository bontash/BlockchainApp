...
const StringEncryption = () => {
    ...
    return <>
        ...
        "here, because these are the only options available on the blockchain. It automatically detects if the input data is a simple string or a hash. A user can select " +
        "multiple hashes to see a clear comparison between them. "} autoHideDuration={45000} open={open} onClose={handleClose} anchorOrigin={{vertical: 'top', horizontal: 'left'}}
        />
        <PageTitle>
            Encryption
        </PageTitle>
