...
const HashProperties = () => {
    ...
    return <>
        ...
        "modification in the input bits(like flipping a bit, what I applied here) should result in a modification of the output bits by ~50% for a good hash function. Another " +
        "property is that the length should always be fixed and not depend on the length of the input. Finally, a good hash function should be quick and easy to compute."} autoHideDuration={40000} open={open} onClose={handleClose} anchorOrigin={{vertical: 'top', horizontal: 'left'}}
        />
